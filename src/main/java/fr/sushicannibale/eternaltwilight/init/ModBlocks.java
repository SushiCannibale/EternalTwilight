...
import fr.sushicannibale.eternaltwilight.blocks.ModFlammableRotatedPillarBlock;
...
public class ModBlocks {
    ...
    public static final RegistryObject<ModFlammableRotatedPillarBlock> VAPORIZED_LOG = register("vaporized_log",
            () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));

    public static final RegistryObject<VacuumLanternBlock> VACUUM_LANTERN = register("vacuum_lantern",
            () -> new VacuumLanternBlock(BlockBehaviour.Properties.of(Material.METAL)
    ...
    public static final RegistryObject<EternalTwilightPortalBlock> ET_PORTAL_BLOCK = registerBlockOnly("eternaltwilight_portal",
            () -> new EternalTwilightPortalBlock(BlockBehaviour.Properties.copy(Blocks.NETHER_PORTAL)));
